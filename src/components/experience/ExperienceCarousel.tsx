        ...
        <div className="sticky top-0 h-screen flex flex-col items-center justify-center overflow-hidden bg-surface-deep">
          ...
          <div className="relative z-10 w-full max-w-6xl mx-auto px-6 flex flex-col items-center pt-20">
            ...
            <div className="text-center mb-4">
              <p className="font-mono text-sm tracking-widest text-accent-primary/80 mb-2">
                {"// 02. EXPERIENCE"}
              </p>
              ...
              <div className="mx-auto mt-5 h-px w-24 bg-gradient-to-r from-transparent via-accent-primary to-transparent" />
            </div>
      ...
      >
        <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6">
          <div className="mb-12 text-center">
            <p className="mb-2 font-mono text-sm tracking-widest text-accent-primary/80">
              {"// 02. EXPERIENCE"}
            </p>
