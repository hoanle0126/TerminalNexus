...
const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  const constants = useMemo(() => ({ borderWidth, cornerSize: size }), [borderWidth, size]);
  ...
  return (
    ...
    >
      ...
      {/* Top-left corner */}
      <div
        className="target-cursor-corner absolute top-1/2 left-1/2"
        style={{
          width: cs,
          height: cs,
          borderTop: `${bw}px solid ${color}`,
          borderLeft: `${bw}px solid ${color}`,
          boxShadow: `0 0 8px ${color}80, inset 0 0 4px ${color}30`,
      ...
      <div
        ...
        style={{
          width: cs,
          height: cs,
          borderBottom: `${bw}px solid ${color}`,
          borderRight: `${bw}px solid ${color}`,
          boxShadow: `0 0 8px ${color}80, inset 0 0 4px ${color}30`,
